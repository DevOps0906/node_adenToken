...
contract AdenCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AdenCoin() {
        ...
        name = "AdenCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ADEN";                                             // Set the symbol for display purposes (CHANGE THIS)
